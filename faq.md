...
containing the UI. That way a change cannot be confined to a SCS, but
...
### Does the user interface of a SCS have to follow ROCA Principles?
...
it is not mandatory to follow them to have a SCS.
